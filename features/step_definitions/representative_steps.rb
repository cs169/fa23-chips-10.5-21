...
Then('I should see the representative\'s address') do
  ...
  unless @representative[:address_street].nil? or @representative[:address_street] == ''
    expect(page).to have_content(@representative[:address_street])
  end
  unless @representative[:address_city].nil? or @representative[:address_city] == ''
    expect(page).to have_content(@representative[:address_city])
  end
  unless @representative[:address_state].nil? or @representative[:address_state] == ''
